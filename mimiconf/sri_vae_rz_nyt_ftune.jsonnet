{
    "vocabulary": {
        "tokens_to_add": {
            "tokens": ["NULL_TOKEN"], 
            "lemmas": ["NULL_LEMMA"],
            "srl_tags": ["O", "A1", "A0", "A2", "AM-TMP", "AM-MNR", "AM-LOC", "A3", "AM-ADV", 
                         "AM-NEG", "A4", "AM-EXT", "AM-CAU", "AM-DIR", "A5", "AM-PRD"], 
        }
    },
    ...
    "tunable": true,
    "old_model_path": "/disk/scratch1/s1847450/model/sri_tl_verb_moved/best.th",
    "update_key_set": {"classifier.seq_encoder": "classifier.seq_encoder", 
                       "classifier.token_embedder": "classifier.token_embedder",
                       "classifier.psign_embedder": "classifier.psign_embedder"},
                       //"classifier.label_projection_layer": "classifier.label_projection_layer"},
    ...
    "model": {
        "autoencoder": {
            ...
            "decoder": {
                ...
                "input_dim": 500,  // // (300) predicate + label + last or (400) + context or (500) + z,
                "hidden_dim": 600, //  
                "always_use_z": true,
