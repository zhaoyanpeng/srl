...
//   He, Luheng et al. “Deep Semantic Role Labeling: What Works and What's Next.” ACL (2017).
{
  ...
  "train_data_path": "/disk/scratch1/s1847450/data/conll09/trial.bit",
  "validation_data_path": "/disk/scratch1/s1847450/data/conll09/trial.bit",
  "model": {
    "type": "srl_naive",
    "text_field_embedder": {
      "token_embedders": {
        "tokens": {
            "type": "embedding",
            "embedding_dim": 300,
            "pretrained_file": "/disk/scratch1/s1847450/data/embeding/glove.6B.300d.vec.c2009",
            "trainable": true 
        }
      }
    },
