...
@DatasetReader.register("srl_ontonotes")
class OntonotesDatasetReader(DatasetReader):
    """
    ...
    def __init__(self,
                 ...
                 feature_labels: Sequence[str] = ('pos',),
        ...
        for sentence in self._ontonotes_subset(ontonotes_reader, file_path, self._domain_identifier):
            ...
            if not sentence.srl_frames:
                ...
                for (_, tags) in sentence.srl_frames:
                    ...
                    yield self.text_to_instance(tokens, verb_indicator, tags, pos_tags)
    ...
    def text_to_instance(self,  # type: ignore
        ...
        metadata = {"words": [x.text for x in tokens], "verb": verb}
