...
class VaeSrlTrainer(Trainer):
    ...
    def batch_loss(self, 
        ...
        try:
            ...
            L = L_u = H = C = None
        return loss, rec_loss, kl_loss, bp_loss, L, L_u, H, C 
    ...
    def _train_epoch(self, epoch: int) -> Dict[str, float]:
        ...
        for batch in train_generator_tqdm:
            ...
            gen_loss, rec_loss, kl_loss, bp_loss, L, L_u, H, C = self.batch_loss(batch, 
                                    for_training=True, 
            ...
            if self.rec_in_training and torch.isnan(rec_loss):
                    raise ValueError("nan loss encountered")
            #print('----------------------0. model.tau is {}'.format(self.model.tau.item()))
    ...
    def _validation_loss(self) -> Tuple[float, int]:
        ...
        for batch in val_generator_tqdm:
            ...
            _, loss, _, _, _, _, _, _ = self.batch_loss(batch, 
                                      for_training=False,
