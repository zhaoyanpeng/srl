...
TEST_DIR = tempfile.mkdtemp(prefix="nlpmimic_tests")

class NlpMimicTestCase(TestCase):  # pylint: disable=too-many-public-methods
    """
    ...
    MODULE_ROOT = PROJECT_ROOT / "nlpmimic"
