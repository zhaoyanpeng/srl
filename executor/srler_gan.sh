...
output_file=/disk/scratch1/s1847450/data/nyt_annotated/xchen/nytimes.tag.verb.part2
log_file=/disk/scratch1/s1847450/data/nyt_annotated/xchen/nytimes.tag.verb.part2.log
bsize=500
cuda_id=0
predictor=srl_naive
...
nohup python -m nlpmimic.run srler_gan --batch-size $bsize --cuda-device $cuda_id \
    ...
    --include-package $library > $log_file 2>&1 &
